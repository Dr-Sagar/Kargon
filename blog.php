...
if (isset($_SERVER['REQUEST_METHOD'])) {
    ...
    $sql_query = "SELECT * FROM blog LEFT JOIN users ON blog.writer=users.userid ORDER BY id DESC ";
...
<head>
    ...
    <style>
        ...
        .mfg{
            margin-left:25px;color:bisque;font-family:'Courier New', Courier, monospace;
        }
    </style>
</head>
